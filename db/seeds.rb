...
20.times do
  User.create(username: Faker::Internet.unique.user_name, password: 'pw', email: Faker::Internet.email, bio: Faker::Hipster.sentence, picture: 'http://graphiccave.com/wp-content/uploads/2015/03/Smile-PNG.png', home_location: Faker::Address.latitude + ',' + Faker::Address.longitude
  )
end
